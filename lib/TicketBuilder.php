<?php 
require_once 'plugins/imprimir_ticket/extras/TicketWriter.php';
require_once 'plugins/servicios/model/servicio_cliente.php';
require_once 'plugins/servicios/controller/imprimir_servicio_ticket.php';
/**
...
class TicketBuilder
{
	...
	/**
	public function servicio_cliente($document, $documentType)
