...
require_once 'plugins/imprimir_ticket/lib/TicketBuilder3.php';
require_once 'plugins/imprimir_ticket/lib/TicketCustomLines3.php';

class imprimir_ticket3 extends fbase_controller
{
    public $mensaje;
    public $documentType;
    public $terminales;
    ...
    {
        parent::__construct(__CLASS__, 'Ticket servicio técnico', 'admin');
    }
    ...
    private function buildTicket($document, $terminal = null)
    {
        ...
        $ticket = new TicketBuilder3($terminal);
    ...
    private function saveCustomHeaderLines()
    {
        ...
        $customLines = new TicketCustomLines3('header');
    ...
    private function saveCustomFooterLines()
    {
        ...
        $customLines = new TicketCustomLines3('footer');
        $customLines->saveCustomLines($data);
    }

    private function loadCustomLines($position)
    {
        return (new TicketCustomLines3($position))->getLines();
    }
    ...
    private function shareExtensions()
    {
        $extensiones = array(
            array(
                ...
                . '<span class="hidden-xs">&nbsp; Ticket técnico</span>',
