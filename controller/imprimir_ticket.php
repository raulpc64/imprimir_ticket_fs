...
require_once 'plugins/imprimir_ticket/lib/TicketBuilder.php';
require_once 'plugins/imprimir_ticket/lib/TicketCustomLines.php';

class imprimir_ticket extends fbase_controller
{
    public $mensaje;
    public $documentType;
    public $terminales;
    ...
    {
        parent::__construct(__CLASS__, 'Ticket general', 'admin');
    }
    ...
    protected function private_core()
    {
        ...
        if ($this->documentType) {
            ...
            switch ($this->documentType) {
				...
				case 'presupuesto':
                    $document = (new presupuesto_cliente())->get($_GET['id']);                    
                    break;
    ...
    private function shareExtensions()
    {
        $extensiones = array(
            array(
                ...
                . '<span class="hidden-xs">&nbsp; Ticket Simplificado</span>',
                'params' => '&tipo=factura',
            ),
            array(
                ...
                'type' => 'modal',
                'text' => '<i class="fa fa-print" aria-hidden="true"></i>'
                . '<span class="hidden-xs">&nbsp; Ticket Albarán</span>',
                'params' => '&tipo=albaran',
            ),
            array(
                ...
                'type' => 'modal',
                'text' => '<i class="fa fa-print" aria-hidden="true"></i>'
                . '<span class="hidden-xs">&nbsp; Ticket Pedido</span>',
                'params' => '&tipo=pedido',
            ),
			array(
                ...
                'type' => 'modal',
                'text' => '<i class="fa fa-print" aria-hidden="true"></i>'
                . '<span class="hidden-xs">&nbsp; Ticket Presupuesto</span>',
