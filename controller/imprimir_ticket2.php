...
require_once 'plugins/imprimir_ticket/lib/TicketBuilder2.php';
require_once 'plugins/imprimir_ticket/lib/TicketCustomLines2.php';

class imprimir_ticket2 extends fbase_controller
{
    public $mensaje;
    public $documentType;
    public $terminales;
    ...
    {
        parent::__construct(__CLASS__, 'Ticket servicio tienda', 'admin');
    }
    ...
    private function buildTicket($document, $terminal = null)
    {
        ...
        $ticket = new TicketBuilder2($terminal);
    ...
    private function saveCustomHeaderLines()
    {
        ...
        $customLines = new TicketCustomLines2('header');
    ...
    private function saveCustomFooterLines()
    {
        ...
        $customLines = new TicketCustomLines2('footer');
        $customLines->saveCustomLines($data);
    }

    private function loadCustomLines($position)
    {
        return (new TicketCustomLines2($position))->getLines();
    }
    ...
    private function shareExtensions()
    {
        $extensiones = array(
            array(
                ...
                . '<span class="hidden-xs">&nbsp; Ticket tienda</span>',
