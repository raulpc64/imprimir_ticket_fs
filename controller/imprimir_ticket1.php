...
require_once 'plugins/imprimir_ticket/lib/TicketBuilder1.php';
require_once 'plugins/imprimir_ticket/lib/TicketCustomLines1.php';

class imprimir_ticket1 extends fbase_controller
{
    public $mensaje;
    public $documentType;
    public $terminales;
    ...
    {
        parent::__construct(__CLASS__, 'Ticket servicio cliente', 'admin');
    }
    ...
    private function buildTicket($document, $terminal = null)
    {
        ...
        $ticket = new TicketBuilder1($terminal);
    ...
    private function saveCustomHeaderLines()
    {
        ...
        $customLines = new TicketCustomLines1('header');
    ...
    private function saveCustomFooterLines()
    {
        ...
        $customLines = new TicketCustomLines1('footer');
        $customLines->saveCustomLines($data);
    }

    private function loadCustomLines($position)
    {
        return (new TicketCustomLines1($position))->getLines();
    }
    ...
    private function shareExtensions()
    {
        $extensiones = array(
            array(
                ...
                . '<span class="hidden-xs">&nbsp; Ticket cliente</span>',
